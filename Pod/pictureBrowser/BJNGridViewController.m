...
@implementation BJNGridViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.collectionView registerClass:[BJNGridCell class] forCellWithReuseIdentifier:@"GridCell"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if (visibleCells) {
        for (BJNGridCell *cell in visibleCells) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BJNGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GridCell" forIndexPath:indexPath];
    if (!cell) {
        cell = [[BJNGridCell alloc] init];
    }
    id <BJNPicture> photo = [_browser thumbPhotoAtIndex:indexPath.row];
    cell.photo = photo;
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    [((BJNGridCell *)cell).photo cancelAnyLoading];
}
