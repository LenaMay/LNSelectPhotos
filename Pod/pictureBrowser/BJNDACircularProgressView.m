...
@interface BJNDACircularProgressView ()

@end

@implementation BJNDACircularProgressView

+ (void) initialize
{
    if (self == [BJNDACircularProgressView class]) {
        BJNDACircularProgressView *circularProgressViewAppearance = [BJNDACircularProgressView appearance];
