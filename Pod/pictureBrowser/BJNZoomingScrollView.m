...
#import "BJNPicture.h"
#import "BJNDALabeledCircularProgressView.h"
#import "BJNPictureBrowserPrivate.h"
//#import "TKActionSheetController.h"

// Private methods and properties
@interface BJNZoomingScrollView () {
    
	BJNTapDetectingView *_tapView; // for background taps
	BJNDALabeledCircularProgressView *_loadingIndicator;
    UIImageView *_loadingError;
    BOOL _isDisplayingImage;
    
}

@property (nonatomic, strong, readwrite) BJNTapDetectingImageView *photoImageView;

@end

@implementation BJNZoomingScrollView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
		...
		_tapView = [[BJNTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[BJNTapDetectingImageView alloc] initWithFrame:CGRectZero];
		...
		// Loading indicator
		_loadingIndicator = [[BJNDALabeledCircularProgressView alloc] initWithFrame:CGRectMake(140.0f, 30.0f, 40.0f, 40.0f)];
...
- (void)imageView:(UIImageView *)imageView longPressDetected:(UIGestureRecognizer *)gest
{
    ...
    UIAlertController *alterView = [UIAlertController alertControllerWithTitle:nil message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    [alterView addAction:save];
    [alterView addAction:cancel];
    [_photoBrowser presentViewController:alterView animated:YES completion:NULL];
//
